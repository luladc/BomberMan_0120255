...
ALaberintoConcreto2::ALaberintoConcreto2()
{
    ...
    {4, 5, 0, 0, 1, 0, 0, 0, 5, 0, 0, 0, 3, 0, 0, 0, 6, 4},
    {4, 2, 3, 6, 1, 2, 6, 0, 5, 0, 6, 0, 3, 2, 1, 0, 6, 4},
    {4, 0, 0, 0, 0, 0, 2, 0, 0, 0, 3, 0, 0, 0, 1, 0, 0, 4},
    {4, 3, 1, 2, 5, 0, 0, 5, 6, 0, 5, 0, 1, 0, 2, 3, 5, 4},
    {4, 0, 0, 2, 0, 2, 0, 0, 0, 1, 0, 0, 0, 6, 0, 3, 0, 4},
    {4, 1, 5, 0, 2, 0, 6, 0, 6, 2, 0, 0, 1, 0, 3, 0, 0, 4},
    {4, 0, 0, 1, 0, 0, 2, 0, 0, 0, 0, 6, 0, 0, 2, 0, 1, 4},
    {4, 0, 2, 0, 0, 4, 0, 0, 5, 0, 0, 2, 0, 0, 0, 6, 0, 4},
    {4, 0, 0, 0, 2, 0, 3, 0, 0, 6, 0, 0, 0, 1, 0, 0, 0, 4},
    {4, 0, 0, 0, 0, 5, 0, 0, 4, 0, 0, 0, 2, 0, 5, 0, 0, 4},
    {4, 0, 0, 0, 3, 5, 0, 0, 0, 2, 0, 0, 0, 0, 0, 5, 0, 4},
    {4, 0, 1, 0, 2, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 3, 0, 4},
    {4, 2, 0, 5, 0, 5, 0, 0, 6, 2, 0, 0, 0, 0, 5, 3, 5, 4},
    {4, 0, 0, 5, 0, 0, 2, 0, 0 ,1, 3, 0, 2, 0, 0, 3, 0, 4},
    {4, 5, 2, 0, 3, 0, 0, 1, 5, 0, 0, 1, 3, 0, 6, 0, 2, 4},
    {4, 1, 0, 5, 0, 3, 0, 1, 0, 2, 3, 0, 0, 3, 0, 0, 6, 4},
    {4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
	};
	...
	MapaDeBloques.Add(1, ABloqueLadrillo::StaticClass());
	MapaDeBloques.Add(2, ABloqueConcreto::StaticClass());
	MapaDeBloques.Add(4, ABloqueAcero::StaticClass());
	MapaDeBloques.Add(3, ABloqueMadera::StaticClass());
	MapaDeBloques.Add(6, ABloqueOro::StaticClass());
	MapaDeBloques.Add(5, ABloqueVidrio::StaticClass());
...
void ALaberintoConcreto2::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ALaberintoConcreto2::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ALaberintoConcreto2::ConstruirMuros()
{
...
void ALaberintoConcreto2::ConstruirBloques()
{
	for (int32 i = 0; i < aMapaBloques.Num(); i++)
	{
		for (int32 j = 0; j < aMapaBloques[i].Num(); j++)
...
void ALaberintoConcreto2::ConstruirObstaculos()
{
...
void ALaberintoConcreto2::ConstruirPuertas()
{
...
ALaberinto* ALaberintoConcreto2::GetLaberinto()
{
